...
import { genreCodes } from "@/lib/genre-codes";
  ...
  return (
    <div className="flex flex-col-reverse w-full ">
      {guessList?.map((guess, ind) => (
        <div
          className="w-full h-fit-content flex flex-col items-center p-8 border "
          key={ind}
        >
          <h1>
            <b>{guess.title}</b>
          </h1>
          <div className="w-full h-fit-content flex flex-col md:flex-row justify-around items-center  p-2">
            <div>
